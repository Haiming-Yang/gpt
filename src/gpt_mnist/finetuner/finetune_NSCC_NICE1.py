...
def do_finetune(args):
    print('Finetuning from finetune_NSCC_NICE1.py')
    SOURCE_PROJECT_ID = 'NSCC_NICE1' #from treasure trove
    ...
    TARGET_LOSS1 = args['TARGET_LOSS1']
    TARGET_LOSS2 = args['TARGET_LOSS2']
    TARGET_LOSS3 = args['TARGET_LOSS3']
